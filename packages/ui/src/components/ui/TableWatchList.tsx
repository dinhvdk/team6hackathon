...
import {
  ...
  getDataBest,
  getDataBlur,
  getDataOpenSea, getDataWatchList,
  getNFTDetail,
  getPrices, removeFromWatchlist,
} from '../../apis.ts'
import { get ,cloneDeep} from 'lodash'


export const TableWatchList: React.FC = ({address}:{address:string}) => {
  ...
  return (
    <div className="overflow-x-auto">
      <table className="table-auto w-full text-sm text-left text-gray-400">
        ...
        <tr>
          <th scope="col" className="px-6 py-3">Listed</th>
          <th scope="col" className="px-6 py-3">Volume/day</th>
          <th scope="col" className="px-6 py-3">Price Blur/Opensea</th>
        ...
        {collectionsData.map((collection, index) => (
          ...
          >
            ...
            <td className={'px-6 py-4'}>
              {get(collection, 'floorPrice.amount', 0)} / {getOpenSeaPrice(collection)} {get(collection, 'floorPrice.unit', '')}
            </td>
            <td className={'px-6 py-4'}>
              ...
              <td className="px-6 py-4">
                <Button onClick={() => handleBuy(collection)}>
                  Buy now
                </Button>
              </td>
          </tr>
